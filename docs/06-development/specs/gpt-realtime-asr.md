...
> 前置调研：`docs/06-development/research/gpt-realtime-whisper.md`。
...
见 `docs/06-development/tasks/gpt-realtime-asr.md`。
...
## 8. 参考
- 调研文档：`docs/06-development/research/gpt-realtime-whisper.md`（端点、协议、模型、计费一手来源）。
